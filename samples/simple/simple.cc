...
int main() {
  ...
  // amount of values.
  auto id = tuner.AddKernel({"../samples/simple/simple_unroll.opencl"}, "matvec_unroll", {(size_t)kSizeM}, {128});
  ...
  id = tuner.AddKernel({"../samples/simple/simple_tiled.opencl"}, "matvec_tiled", { (size_t)kSizeM}, {1});
  ...
  tuner.SetReference({"../samples/simple/simple_reference.opencl"}, "matvec_reference", { (size_t)kSizeM}, {128});
